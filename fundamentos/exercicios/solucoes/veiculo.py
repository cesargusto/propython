...
class Veiculo(object):
    def __init__(self, pos=None, vel=None, acel=None):
        ''' instâncias de veículo começam com parâmetros zerados por default
        ...
        self.vel = (0, 0, 0) if vel is None else vel
        self.acel = (0, 0, 0) if acel is None else acel
    
    def parar(self):
        ''' zera a velocidade do veiculo nos três eixos
            
            >>> nave = Veiculo(pos=(10,5,9), vel=(0,-5,-5))
            >>> nave.parar()
            >>> nave.vel
            (0, 0, 0)
